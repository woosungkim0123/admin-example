...
-- 123 게시글
insert into post (user_account_id, title, content, hashtag, created_by, modified_by, created_at, modified_at) values
...
-- 1000 댓글
insert into post_comment (post_id, user_account_id, content, created_at, modified_at, created_by, modified_by) values
